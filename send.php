...
{*/
    ...
    $mail->AddReplyTo("info@alumostroy.ru","Алюмо Строй");
    $mail->SetFrom('info@alumostroy.ru', 'Алюмо Строй');

    $address = "info@alumostroy.ru";
    $mail->AddAddress($address, "Алюмо Строй");

    $mail->AddAddress("pashachiho@gmail.com", "Алюмо Строй");
    $mail->AddAddress("alumo88@mail.ru", "Алюмо Строй");

    $mail->Subject    = "Остекление коттеджей ".$_POST["title"];
